...
from cms.auth.schemas import CustomUserCreate, RegisterUserResponse, ErrorResponse, LoginResponse
...
def login(user: CustomUserCreate, db: Session = Depends(get_db)):
